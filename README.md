...
分析グラフ（`keiba\\\_analysis.png`）を生成します。
...
## \### 機械学習予測モデル（prediction.py）

## \- Random Forest Classifierを用いた3着以内予測

## \- 特徴量: 人気、出走頭数、距離、コース種別、馬の過去成績（平均着順・勝率・複勝率・出走数）

## \- 予測精度: 約83% （混同行列で検証）

## \- 特徴量重要度の可視化により、どの要素が予測に影響するかを分析
